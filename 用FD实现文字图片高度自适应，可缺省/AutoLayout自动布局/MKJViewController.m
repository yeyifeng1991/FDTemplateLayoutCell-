...
#pragma mark - 返回高度
    ...
    NSArray *descArr = @[@"愤怒的时间发货的收款计划发放贷款结构合理收费价格了快速分解管理会计师法规；建设路口；价格开始；浪费",@"愤怒的时间发货的收款计划发放贷款结构合理收费价格了快速分解管理会计师法规；建设路口；价格开始；浪费",@"建设路口；价格开始；浪费",@"合理收费价格了快速分解管理会计师法规",@"愤怒的时间发货的收款计划发放贷款结构合理收费价格了快速分解管",@"合理收费价格了快速分解管理会计师法规；建设社会主义新中国"];
...
- (void)configCell:(MKJTableViewCell *)cell indexpath:(NSIndexPath *)index
{
    ...
    {
#pragma mark - 重点隐藏图片的显示，把图片的高度约束设为0，底部距上的约束也改为0
        // 主要图片隐藏
